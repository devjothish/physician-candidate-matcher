...
PII is never included in log output - candidate names, patient data,
and other sensitive fields must be stripped before logging.
"""
...
def get_logger(name: str) -> structlog.stdlib.BoundLogger:
    ...
    Returns:
        A structured logger bound with the given name.
    """
