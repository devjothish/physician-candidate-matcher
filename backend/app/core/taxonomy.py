...
PHYSICIAN_TAXONOMY: list[TaxonomyEntry] = [
    ...
    TaxonomyEntry("207KI0005X", "Allergy & Immunology", "Clinical & Laboratory Immunology", "Clinical & Laboratory Immunology Physician"),
    # Anesthesiology
    TaxonomyEntry("207L00000X", "Anesthesiology", "", "Anesthesiology Physician"),
    TaxonomyEntry("207LA0401X", "Anesthesiology", "Addiction Medicine", "Addiction Medicine (Anesthesiology) Physician"),
    TaxonomyEntry("207LC0200X", "Anesthesiology", "Critical Care Medicine", "Critical Care Medicine (Anesthesiology) Physician"),
    TaxonomyEntry("207LH0002X", "Anesthesiology", "Hospice and Palliative Medicine", "Hospice and Palliative Medicine (Anesthesiology) Physician"),
    ...
    TaxonomyEntry("207NI0002X", "Dermatology", "Clinical & Laboratory Dermatological Immunology", "Dermatological Immunology Physician"),
    ...
    TaxonomyEntry("207PE0004X", "Emergency Medicine", "Emergency Medical Services", "Emergency Medical Services Physician"),
    TaxonomyEntry("207PT0002X", "Emergency Medicine", "Medical Toxicology", "Medical Toxicology Physician"),
    TaxonomyEntry("207PP0204X", "Emergency Medicine", "Pediatric Emergency Medicine", "Pediatric Emergency Medicine Physician"),
    TaxonomyEntry("207PS0010X", "Emergency Medicine", "Sports Medicine", "Sports Medicine (Emergency Medicine) Physician"),
    TaxonomyEntry("207PE0005X", "Emergency Medicine", "Undersea and Hyperbaric Medicine", "Undersea and Hyperbaric Medicine Physician"),
    # Family Medicine
    TaxonomyEntry("207Q00000X", "Family Medicine", "", "Family Medicine Physician"),
    TaxonomyEntry("207QA0401X", "Family Medicine", "Addiction Medicine", "Addiction Medicine (Family Medicine) Physician"),
    TaxonomyEntry("207QA0000X", "Family Medicine", "Adolescent Medicine", "Adolescent Medicine Physician"),
    TaxonomyEntry("207QG0300X", "Family Medicine", "Geriatric Medicine", "Geriatric Medicine (Family Medicine) Physician"),
    ...
    TaxonomyEntry("207RA0001X", "Internal Medicine", "Advanced Heart Failure and Transplant Cardiology", "Advanced Heart Failure Physician"),
    TaxonomyEntry("207RA0002X", "Internal Medicine", "Adult Congenital Heart Disease", "Adult Congenital Heart Disease Physician"),
    TaxonomyEntry("207RA0201X", "Internal Medicine", "Allergy & Immunology", "Allergy & Immunology (Internal Medicine) Physician"),
    TaxonomyEntry("207RC0000X", "Internal Medicine", "Cardiovascular Disease", "Cardiovascular Disease Physician"),
    TaxonomyEntry("207RC0001X", "Internal Medicine", "Clinical Cardiac Electrophysiology", "Clinical Cardiac Electrophysiology Physician"),
    TaxonomyEntry("207RC0200X", "Internal Medicine", "Critical Care Medicine", "Critical Care Medicine (Internal Medicine) Physician"),
    ...
    TaxonomyEntry("207RG0300X", "Internal Medicine", "Geriatric Medicine", "Geriatric Medicine (Internal Medicine) Physician"),
    ...
    TaxonomyEntry("207RI0011X", "Internal Medicine", "Interventional Cardiology", "Interventional Cardiology Physician"),
    ...
    TaxonomyEntry("207RS0010X", "Internal Medicine", "Sports Medicine", "Sports Medicine (Internal Medicine) Physician"),
    ...
    TaxonomyEntry("207VC0200X", "Obstetrics & Gynecology", "Critical Care Medicine", "Critical Care Medicine (OB/GYN) Physician"),
    ...
    TaxonomyEntry("207VM0101X", "Obstetrics & Gynecology", "Maternal & Fetal Medicine", "Maternal & Fetal Medicine Physician"),
    TaxonomyEntry("207VX0000X", "Obstetrics & Gynecology", "Obstetrics", "Obstetrics Physician"),
    TaxonomyEntry("207VE0102X", "Obstetrics & Gynecology", "Reproductive Endocrinology", "Reproductive Endocrinology Physician"),
    # Ophthalmology
    ...
    TaxonomyEntry("207XS0114X", "Orthopaedic Surgery", "Adult Reconstructive Orthopaedic Surgery", "Adult Reconstructive Orthopaedic Surgery Physician"),
    TaxonomyEntry("207XX0004X", "Orthopaedic Surgery", "Foot and Ankle Surgery", "Orthopaedic Foot and Ankle Surgery Physician"),
    ...
    TaxonomyEntry("207XP3100X", "Orthopaedic Surgery", "Pediatric Orthopaedic Surgery", "Pediatric Orthopaedic Surgery Physician"),
    TaxonomyEntry("207XX0005X", "Orthopaedic Surgery", "Sports Medicine", "Sports Medicine (Orthopaedic Surgery) Physician"),
    # Otolaryngology
    ...
    TaxonomyEntry("2080I0007X", "Pediatrics", "Clinical & Laboratory Immunology", "Clinical & Laboratory Immunology (Pediatrics) Physician"),
    TaxonomyEntry("2080P0006X", "Pediatrics", "Developmental-Behavioral Pediatrics", "Developmental-Behavioral Pediatrics Physician"),
    TaxonomyEntry("2080H0002X", "Pediatrics", "Hospice and Palliative Medicine", "Hospice and Palliative Medicine (Pediatrics) Physician"),
    TaxonomyEntry("2080N0001X", "Pediatrics", "Neonatal-Perinatal Medicine", "Neonatal-Perinatal Medicine Physician"),
    TaxonomyEntry("2080P0008X", "Pediatrics", "Neurodevelopmental Disabilities", "Neurodevelopmental Disabilities Physician"),
    ...
    TaxonomyEntry("2080P0203X", "Pediatrics", "Pediatric Critical Care Medicine", "Pediatric Critical Care Medicine Physician"),
    TaxonomyEntry("2080P0204X", "Pediatrics", "Pediatric Emergency Medicine", "Pediatric Emergency Medicine (Pediatrics) Physician"),
    ...
    TaxonomyEntry("2080P0207X", "Pediatrics", "Pediatric Hematology-Oncology", "Pediatric Hematology-Oncology Physician"),
    TaxonomyEntry("2080P0208X", "Pediatrics", "Pediatric Infectious Diseases", "Pediatric Infectious Diseases Physician"),
    ...
    TaxonomyEntry("2080T0004X", "Pediatrics", "Pediatric Transplant Hepatology", "Pediatric Transplant Hepatology Physician"),
    # Physical Medicine & Rehabilitation
    TaxonomyEntry("208100000X", "Physical Medicine & Rehabilitation", "", "Physical Medicine & Rehabilitation Physician"),
    TaxonomyEntry("2081H0002X", "Physical Medicine & Rehabilitation", "Hospice and Palliative Medicine", "Hospice and Palliative Medicine (PM&R) Physician"),
    TaxonomyEntry("2081N0001X", "Physical Medicine & Rehabilitation", "Neuromuscular Medicine", "Neuromuscular Medicine (PM&R) Physician"),
    TaxonomyEntry("2081P2900X", "Physical Medicine & Rehabilitation", "Pain Medicine", "Pain Medicine (PM&R) Physician"),
    TaxonomyEntry("2081P0010X", "Physical Medicine & Rehabilitation", "Pediatric Rehabilitation Medicine", "Pediatric Rehabilitation Medicine Physician"),
    TaxonomyEntry("2081S0010X", "Physical Medicine & Rehabilitation", "Sports Medicine", "Sports Medicine (PM&R) Physician"),
    TaxonomyEntry("2081P0004X", "Physical Medicine & Rehabilitation", "Spinal Cord Injury Medicine", "Spinal Cord Injury Medicine Physician"),
    # Plastic Surgery
    TaxonomyEntry("208200000X", "Plastic Surgery", "", "Plastic Surgery Physician"),
    TaxonomyEntry("2082S0099X", "Plastic Surgery", "Plastic Surgery Within the Head and Neck", "Plastic Surgery Within the Head and Neck Physician"),
    TaxonomyEntry("2082S0105X", "Plastic Surgery", "Surgery of the Hand", "Surgery of the Hand (Plastic Surgery) Physician"),
    # Preventive Medicine
    ...
    TaxonomyEntry("2083B0002X", "Preventive Medicine", "Obesity Medicine", "Obesity Medicine (Preventive Medicine) Physician"),
    TaxonomyEntry("2083P0500X", "Preventive Medicine", "Preventive Medicine/Occupational Environmental Medicine", "Occupational Medicine Physician"),
    TaxonomyEntry("2083P0901X", "Preventive Medicine", "Public Health & General Preventive Medicine", "Public Health Physician"),
    # Psychiatry & Neurology
    TaxonomyEntry("2084A0401X", "Psychiatry & Neurology", "Addiction Medicine", "Addiction Medicine (Psychiatry) Physician"),
    TaxonomyEntry("2084A2900X", "Psychiatry & Neurology", "Neurocritical Care", "Neurocritical Care Physician"),
    TaxonomyEntry("2084B0002X", "Psychiatry & Neurology", "Obesity Medicine", "Obesity Medicine (Psychiatry & Neurology) Physician"),
    TaxonomyEntry("2084D0003X", "Psychiatry & Neurology", "Diagnostic Neuroimaging", "Diagnostic Neuroimaging Physician"),
    TaxonomyEntry("2084F0202X", "Psychiatry & Neurology", "Forensic Psychiatry", "Forensic Psychiatry Physician"),
    TaxonomyEntry("2084H0002X", "Psychiatry & Neurology", "Hospice and Palliative Medicine", "Hospice and Palliative Medicine (Psychiatry) Physician"),
    ...
    TaxonomyEntry("2084N0402X", "Psychiatry & Neurology", "Neurology with Special Qualifications in Child Neurology", "Child Neurology Physician"),
    TaxonomyEntry("2084N0600X", "Psychiatry & Neurology", "Clinical Neurophysiology", "Clinical Neurophysiology Physician"),
    TaxonomyEntry("2084P0005X", "Psychiatry & Neurology", "Neurodevelopmental Disabilities", "Neurodevelopmental Disabilities (Psychiatry) Physician"),
    ...
    TaxonomyEntry("2084P0804X", "Psychiatry & Neurology", "Child & Adolescent Psychiatry", "Child & Adolescent Psychiatry Physician"),
    TaxonomyEntry("2084P0805X", "Psychiatry & Neurology", "Consultation-Liaison Psychiatry", "Consultation-Liaison Psychiatry Physician"),
    TaxonomyEntry("2084P2900X", "Psychiatry & Neurology", "Pain Medicine", "Pain Medicine (Psychiatry & Neurology) Physician"),
    TaxonomyEntry("2084S0010X", "Psychiatry & Neurology", "Sports Medicine", "Sports Medicine (Psychiatry & Neurology) Physician"),
    TaxonomyEntry("2084S0012X", "Psychiatry & Neurology", "Sleep Medicine", "Sleep Medicine (Psychiatry & Neurology) Physician"),
    ...
    TaxonomyEntry("2085D0003X", "Radiology", "Diagnostic Neuroimaging", "Diagnostic Neuroimaging (Radiology) Physician"),
    TaxonomyEntry("2085H0002X", "Radiology", "Hospice and Palliative Medicine", "Hospice and Palliative Medicine (Radiology) Physician"),
    ...
    TaxonomyEntry("2085R0204X", "Radiology", "Vascular & Interventional Radiology", "Vascular & Interventional Radiology Physician"),
    ...
    TaxonomyEntry("2086H0002X", "Surgery", "Hospice and Palliative Medicine", "Hospice and Palliative Medicine (Surgery) Physician"),
    TaxonomyEntry("2086S0120X", "Surgery", "Pediatric Surgery", "Pediatric Surgery Physician"),
    TaxonomyEntry("2086S0122X", "Surgery", "Plastic and Reconstructive Surgery", "Plastic and Reconstructive Surgery Physician"),
    ...
    TaxonomyEntry("2086S0130X", "Thoracic Surgery (Cardiothoracic Vascular Surgery)", "Congenital Cardiac Surgery", "Congenital Cardiac Surgery Physician"),
    # Urology
    TaxonomyEntry("208800000X", "Urology", "", "Urology Physician"),
    TaxonomyEntry("2088P0231X", "Urology", "Female Pelvic Medicine and Reconstructive Surgery", "Female Pelvic Medicine Physician"),
...
_RELATED_CLASSIFICATIONS: dict[str, set[str]] = {
    ...
    "Surgery": {"Orthopaedic Surgery", "Thoracic Surgery (Cardiothoracic Vascular Surgery)", "Plastic Surgery", "Colon & Rectal Surgery"},
...
def find_related(classification: str) -> list[str]:
    ...
    return [
        e.specialization
        for e in PHYSICIAN_TAXONOMY
        if e.classification == cls_normalized and e.specialization
    ]
